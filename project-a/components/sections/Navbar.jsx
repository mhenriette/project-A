...
export default function Navbar() {
  return<div className="mx-auto container absolute">
    <div className="bg-gradient-to-r from-[#ff0d4f] to-black w-full px-32 ">
        <div className=" py-3">
        <p className="font-semibold text-[1em] text-white ">Project A leads the seed funding round for <span>Growblocks </span>. More 
